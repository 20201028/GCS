...
def generateQuery(root, dataset, train_comms_r, val_comms_r, train_path, val_path, test_path):
    ...
    val_comms_n = int(len(truthComms)*val_comms_r)
    train_comms = truthComms[:train_comms_n]
    val_comms = truthComms[train_comms_n:val_comms_n]
    test_comms = truthComms[val_comms_n:]
    train_lists = []
    for cid, comm in train_comms:
